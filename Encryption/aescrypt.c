...
aes_rval aes_ecb_encrypt(const unsigned char *in, unsigned char *out,
                             int no_block, const aes_encrypt_ctx cx[1])
#endif
...
/* order as that used for encrytpion (where the 1st decryptiony */
/* round key is at the high end ot the schedule) or with a key  */
/* schedule that has been reversed to put the 1st decryption    */
/* round key at the low end of the schedule in memory (this is  */
/* when AES_REV_DKS is defined)                                 */
...
aes_rval aes_ecb_decrypt(const unsigned char *in, unsigned char *out,
                              int no_block, const aes_decrypt_ctx cx[1])
#endif
{   aes_32t        locals(b0, b1);
